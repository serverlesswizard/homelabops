...
If you have any questions after reading, please contact the community via one or more of the [available channels](https://github.com/ansible-collections/ansible.mariadb#communication). Any feedback on this guide is very welcome.
...
- Any autonomous contributions submitted by AI tools MAY be rejected by project maintainers without prior justification.

We recommend using the [AGENTS.md](https://github.com/ansible-collections/ansible.mariadb/blob/main/AGENTS.md) file and [skills](https://github.com/ansible-collections/ansible.mariadb/tree/main/.agents/skills) provided in this repository when contributing with AI tools.
...
- **Atomic commits**: use [Conventional Commits](https://www.conventionalcommits.org/) prefixes in your commit messages: `feat:`, `fix:`, `docs:`, `test:`, `refactor:`, `chore:`, `ci:`. For example: `fix: handle empty database list in clickhouse_info`.
...
The jobs are launched automatically by GitHub Actions in every PR based on the [matrix](https://github.com/ansible-collections/ansible.mariadb/blob/main/.github/workflows/ansible-test-plugins.yml).
...
Read more about our CI implementation in the [TESTING.md](https://github.com/ansible-collections/ansible.mariadb/blob/main/TESTING.md) file.
...
See the [TESTING.md](https://github.com/ansible-collections/ansible.mariadb/blob/main/TESTING.md) file to learn how to run integration tests against different server/connector versions.
