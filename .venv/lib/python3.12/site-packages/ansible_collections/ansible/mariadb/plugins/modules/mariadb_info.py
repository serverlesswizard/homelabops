...
- module: ansible.mariadb.mariadb_db
- module: ansible.mariadb.mariadb_user
- module: ansible.mariadb.mariadb_replication
...
users_info:
  description:
    ...
    - The output can be used as an input of the M(ansible.mariadb.mariadb_user) plugin.
    ...
    - Causes issues with authentications plugins C(sha256_password) and C(caching_sha2_password).
      If the output is fed to M(ansible.mariadb.mariadb_user), the
