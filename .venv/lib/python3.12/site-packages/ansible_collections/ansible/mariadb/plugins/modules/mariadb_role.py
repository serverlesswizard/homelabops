  ...
  priv:
    description:
      ...
      - Supports GRANTs for procedures and functions
        (see the examples for the M(ansible.mariadb.mariadb_user) module).
    type: raw
...
seealso:
  - module: ansible.mariadb.mariadb_user
...
#   'yetanotherdb.*': 'ALL'
#
# You can also use the string format like in the ansible.mariadb.mariadb_user module, for example
# mydb.*:INSERT,UPDATE/anotherdb.*:SELECT/yetanotherdb.*:ALL
#
# For more examples on how to specify privileges, refer to the ansible.mariadb.mariadb_user module
