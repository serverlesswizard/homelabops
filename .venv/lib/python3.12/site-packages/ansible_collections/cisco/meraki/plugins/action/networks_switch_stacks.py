...
required_if = [
    ("state", "present", ["name", "networkId", "switchStackId"], True),
    ("state", "absent", ["name", "networkId", "switchStackId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class NetworksSwitchStacks(object):
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.meraki.exec_meraki(
                family="switch",
                function="getNetworkSwitchStack",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworksSwitchStacks(self._task.args, meraki)
